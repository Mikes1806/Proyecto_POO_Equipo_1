...
#from iconos_x_tipo_servicio import iconos_servicio
 ...
 def logic(self):
        ...
        try:
            ...
            if df_gastos_fijos.empty:
              ...
              tab_mostrar_gastos,tab_agregar_gastos ,tab_modificacion_gastos = st.tabs(["Mi informacion","Agregar nuevo gasto" ,"Modificacion de informacion"])
 ...
 def _modify_gastos(self, df_gastos_fijos):
      ...
      if not df_gastos_fijos.empty:
            selected_servicio = st.selectbox(
              ...
              df_gastos_fijos['Servicio']
            )

            if selected_servicio is not None:

                st.write(f" {selected_servicio}") 
                selected_record = df_gastos_fijos[df_gastos_fijos['Servicio'] == selected_servicio].iloc[0]
                ...
                if st.button("Guardar Cambios", key="save_button"):
                    ...
                    df_gastos_fijos.loc[df_gastos_fijos['Servicio'] == selected_servicio, 'Categoria'] = tipo_categoria
                    df_gastos_fijos.loc[df_gastos_fijos['Servicio'] == selected_servicio, 'Servicio'] = tipo_servicio
                    df_gastos_fijos.loc[df_gastos_fijos['Servicio'] == selected_servicio, 'Gasto mensual'] = gasto_mensual
                    df_gastos_fijos.loc[df_gastos_fijos['Servicio'] == selected_servicio, 'Descripcion'] = descripcion
                    df_gastos_fijos.loc[df_gastos_fijos['Servicio'] == selected_servicio, 'Comentario'] = comentario
                ...
                if st.button("Eliminar gasto", key="save_button2"):
                   ...
                   df_gastos_fijos = df_gastos_fijos[df_gastos_fijos['Servicio'] != selected_servicio] 
